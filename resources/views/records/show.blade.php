...
<!--                      <thead>
        ...
        <div class="row mt-5">
            ...
            <div class="col-sm-4">
                <a class="btn btn-info" href="{{url('doctors/records/'.$record->id.'/edit')}}">Update Record</a>
            <a class="btn btn-success" href="{{url('/doctors/records/'.$record->id.'/pdf')}}">Export Record</a>
            </div>
        </div>
